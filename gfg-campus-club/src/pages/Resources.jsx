...
const styles = {
  page: { padding: "40px 48px", fontFamily: "'Segoe UI', sans-serif", maxWidth: "1400px", margin: "0 auto", color: "#1a1a1a" },
  title: { fontSize: "2rem", fontWeight: "800", marginBottom: "8px" },
  subtitle: { color: "#666", fontSize: "1rem", marginBottom: "24px" },
  searchBox: { width: "100%", maxWidth: "420px", padding: "12px 16px", border: "1px solid #ddd", borderRadius: "8px", fontSize: "0.97rem", marginBottom: "40px", boxSizing: "border-box", fontFamily: "inherit" },
  section: { marginBottom: "44px" },
  sectionTitle: { fontSize: "1.2rem", fontWeight: "700", borderLeft: "4px solid #2f8d46", paddingLeft: "12px", marginBottom: "18px" },
  cardGrid: { display: "flex", gap: "16px", flexWrap: "wrap" },
  card: { border: "1px solid #e0e0e0", padding: "18px 20px", width: "240px", borderRadius: "10px", background: "white", boxShadow: "0 2px 6px rgba(0,0,0,0.05)", display: "flex", flexDirection: "column", gap: "6px" },
  cardTitle: { fontWeight: "700", fontSize: "0.95rem", color: "#1a1a1a" },
  cardDesc: { color: "#666", fontSize: "0.87rem", lineHeight: "1.5", flex: 1 },
  link: { color: "#2f8d46", fontWeight: "700", fontSize: "0.87rem", textDecoration: "none", marginTop: "4px" },
  noResults: { color: "#888", fontSize: "1rem", padding: "24px 0" }
}
...
function ResourceCard({ title, desc, link }) {
  return (
    <div style={styles.card}>
      ...
      <a href={link} target="_blank" rel="noreferrer" style={styles.link}>Explore →</a>
    </div>
  )
}
